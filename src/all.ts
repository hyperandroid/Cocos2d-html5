...
/// <reference path="render/shader/Uniform.ts"/>
/// <reference path="render/shader/Attribute.ts"/>
/// <reference path="render/shader/AbstractShader.ts"/>
/// <reference path="render/shader/SolidColorShader.ts"/>
/// <reference path="render/shader/TextureShader.ts"/>
/// <reference path="render/shader/TexturePatternShader.ts"/>
/// <reference path="render/shader/Buffer.ts"/>

/// <reference path="render/Texture2D.ts"/>
/// <reference path="render/Renderer.ts"/>
/// <reference path="render/RenderingContext.ts"/>
/// <reference path="render/RenderingContextSnapshot.ts"/>
...
/// <reference path="plugin/font/SpriteFontHelper.ts"/>

/// <reference path="plugin/texture/TexturePacker.ts"/>

/// <reference path="plugin/loader/ResourceLoader.ts"/>
/// <reference path="plugin/loader/Resource.ts"/>
/// <reference path="plugin/loader/ResourceLoaderImage.ts"/>
/// <reference path="plugin/loader/ResourceLoaderJSON.ts"/>
/// <reference path="plugin/loader/ResourceLoaderAudioBuffer.ts"/>
/// <reference path="plugin/loader/Loader.ts"/>

/// <reference path="plugin/asset/AssetManager.ts"/>
/// <reference path="plugin/asset/AssetManagerV3.ts"/>

/// <reference path="plugin/audio/AudioManager.ts"/>

/// <reference path="plugin/layout/LayoutManager.ts"/>
...
/// <reference path="input/KeyboardInputManager.ts"/>

/// <reference path="render/ScaleManager.ts"/>
/// <reference path="game/Game.ts"/>

/// <reference path="util/Measure.ts"/>
