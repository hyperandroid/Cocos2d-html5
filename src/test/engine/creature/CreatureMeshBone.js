...
dualQuat.prototype.add = function(quat_in, real_factor, imaginary_factor)
{
	...
	this.tmpQ1 = quat.scale(this.tmpQ1, this.tmpQ1, real_factor);
	this.real = quat.add(this.real, this.tmpQ1, this.real);
    ...
    this.tmpQ1 = quat.scale(this.tmpQ1, this.tmpQ1, imaginary_factor);
	this.imaginary = quat.add(this.imaginary, this.tmpQ1, this.imaginary);
};
...
CreatureManager.prototype.PoseCreature = function(animation_name_in, target_pts)
{
  ...
  for(var j = 0; j < cur_regions.length; j++) {
    ...
    for(var k = cur_region.getStartPtIndex() * 3;
